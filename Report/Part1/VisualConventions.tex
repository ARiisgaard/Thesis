\chapter{Visual conventions}\label{CVisualConventions}
...
%As mentioned in chapter \ref{Intro} the data is in the raster format and is sequential. Visual conventions connected to discrete-objects will therefore not be covered.
%
...
%Naturally the different colors should be easily distinguishable, but one should also consider the user of the map and the medium used for presenting the map. 
